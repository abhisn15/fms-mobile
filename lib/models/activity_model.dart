...
class DailyActivity {
  ...
  final String activityType; // normal, before, after
  ...
  factory DailyActivity.fromJson(Map<String, dynamic> json) {
    ...
    final activityTypeValue = (json['activityType'] ?? json['activity_type'] ?? 'normal').toString();
    ...
    return DailyActivity(
      ...
      activityType: activityTypeValue.isNotEmpty ? activityTypeValue : 'normal',
